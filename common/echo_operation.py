...
from project import ECHO_OPERATIONS, WALLETS
...
class EchoOperations(object):
    ...
    def get_override_transfer_operation(
        self,
        echo,
        issuer,
        from_account_id,
        ...
        override_transfer_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        override_transfer_props.update({
            "issuer": issuer,
            "from": from_account_id,
            "to": to_account_id,
            "extensions": extensions
        })
        override_transfer_props["amount"].update({
            "amount": amount,
            "asset_id": amount_asset_id
        })
        if debug_mode:
    ...
    def get_account_create_operation(
        self,
        echo,
        name,
        active_key_auths,
        ...
        active_account_auths=None,
        options_delegating_account="1.2.11",
        delegate_share=0,
        options_extensions=None,
        extensions=None,
        signer=None,
        debug_mode=False
    ):
        ...
        account_create_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        ...
        account_create_props["options"].update({
            "delegating_account": options_delegating_account,
    ...
    def get_account_update_operation(
        self,
        echo,
        account,
        ...
        account_update_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        account_update_props.update({
            "account": account,
            "extensions": extensions
        })
        ...
        if delegating_account is not None:
            account_update_props["new_options"].update({
                "delegating_account": delegating_account,
                "delegate_share": delegate_share
            })
        else:
    ...
    def get_account_whitelist_operation(
        self,
        echo,
        authorizing_account,
        account_to_list=None,
        new_listing=None,
        fee_amount=0,
        fee_asset_id="1.3.0",
        extensions=None,
        ...
        account_whitelist_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        account_whitelist_props.update({
    ...
    def get_asset_create_operation(
        self,
        echo,
        issuer,
        symbol,
    ...
    def get_asset_update_operation(
        self,
        echo,
        issuer,
        asset_to_update,
    ...
    def get_asset_update_bitasset_operation(
        self,
        echo,
        issuer,
        asset_to_update,
        ...
        asset_update_bitasset_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        ...
        if debug_mode:
            lcc.log_debug(
                "Asset update bitasset operation: \n{}".format(
                    json.dumps([operation_id, asset_update_bitasset_props], indent=4)
                )
            )
        if signer is None:
    ...
    def get_asset_update_feed_producers_operation(
        self,
        echo,
        issuer,
        asset_to_update,
        ...
        asset_update_feed_producers_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        ...
        if debug_mode:
            lcc.log_debug(
                "Create update feed producers operation: \n{}".format(
    ...
    def get_asset_issue_operation(
        ...
        asset_issue_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        asset_issue_props.update({
            "issuer": issuer,
            "issue_to_account": issue_to_account,
            "extensions": extensions
        })
        asset_issue_props["asset_to_issue"].update({
            "amount": value_amount,
    ...
    def get_asset_reserve_operation(
        self,
        echo,
        payer,
        reserve_amount=0,
        reserve_asset_id="1.3.0",
        fee_amount=0,
        fee_asset_id="1.3.0",
        extensions=None,
        signer=None,
        ...
        asset_reserve_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        asset_reserve_props.update({
            "payer": payer,
            "extensions": extensions
        })
        asset_reserve_props["amount_to_reserve"].update({
    ...
    def get_asset_fund_fee_pool_operation(
        self,
        echo,
        from_account,
        asset_id="1.3.0",
        ...
        asset_fund_fee_pool_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        asset_fund_fee_pool_props.update({
    ...
    def get_asset_publish_feed_operation(
        self,
        echo,
        publisher,
        asset_id,
        ...
        asset_publish_feed_props["fee"].update({
            "amount": fee_amount,
            "fee_asset_id": fee_asset_id
        })
        asset_publish_feed_props.update({
            "publisher": publisher,
            "asset_id": asset_id,
            "extensions": extensions
        })
    ...
    def get_asset_claim_fees_operation(
        self,
        echo,
        issuer,
        claim_amount=0,
        claim_asset_id="1.3.0",
        fee_amount=0,
        fee_asset_id="1.3.0",
        extensions=None,
        signer=None,
        ...
        asset_claim_fees_props["fee"].update({
            "amount": fee_amount,
            "fee_asset_id": fee_asset_id
        })
        asset_claim_fees_props.update({
            "issuer": issuer,
            "extensions": extensions
        })
        asset_claim_fees_props["amount_to_claim"].update({
            "amount": claim_amount,
    ...
    def get_proposal_create_operation(
        self,
        echo,
        fee_paying_account,
        expiration_time,
    ...
    def get_proposal_update_operation(
        self,
        echo,
        fee_paying_account,
        proposal,
        ...
        proposal_update_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
    ...
    def get_proposal_delete_operation(
        self,
        echo,
        fee_paying_account,
        ...
        proposal_delete_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        proposal_delete_props.update({
            "fee_paying_account": fee_paying_account,
    ...
    def get_committee_member_create_operation(
        self,
        echo,
        ...
        committee_member_create_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        committee_member_create_props["deposit"].update({
        ...
        if debug_mode:
            lcc.log_debug(
                "Committee member create operation: \n{}".format(
    ...
    def get_committee_member_update_operation(
        self,
        echo,
        committee_member,
        committee_member_account,
        new_eth_address=None,
        new_btc_public_key=None,
        new_url=None,
        fee_amount=0,
        fee_asset_id="1.3.0",
        extensions=None,
        ...
        committee_member_update_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        ...
        if debug_mode:
            lcc.log_debug(
                "Committee member update operation: \n{}".format(
    ...
    def get_committee_member_update_global_parameters_operation(self, echo, _time_net_1mb, signer, debug_mode=False):
        ...
        if debug_mode:
            lcc.log_debug(
                "Committee frozen balance deposit operation: \n{}".format(
    ...
    def get_committee_frozen_balance_deposit_operation(
        self,
        echo,
        committee_member,
        committee_member_account,
        ...
        committee_frozen_balance_deposit_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        ...
        committee_frozen_balance_deposit_props["amount"].update({
            "amount": amount,
            "asset_id": asset_id
        })
    ...
    def get_committee_frozen_balance_withdraw_operation(
        self,
        echo,
        committee_member_account,
        amount=0,
        ...
        committee_frozen_balance_withdraw_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        committee_frozen_balance_withdraw_props.update({"committee_member_account": committee_member_account})
        committee_frozen_balance_withdraw_props["amount"].update({
            "amount": amount,
            "asset_id": asset_id
        })
        if debug_mode:
    ...
    def get_committee_member_activate_operation(
        self,
        echo,
        committee_to_activate,
        ...
        committee_member_activate_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        ...
        if debug_mode:
            lcc.log_debug(
                "Committee member activate operation: \n{}".format(
    ...
    def get_committee_member_deactivate_operation(
        self,
        echo,
        committee_to_deactivate,
        committee_member_account,
        fee_amount=0,
        fee_asset_id="1.3.0",
        extensions=None,
        ...
        committee_member_deactivate_props = deepcopy(self.get_operation_json("committee_member_deactivate_operation"))
        committee_member_deactivate_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        ...
        if debug_mode:
            lcc.log_debug(
                "Committee member deactivate operation: \n{}".format(
    ...
    def get_vesting_balance_create_operation(
        self,
        echo,
        creator,
        owner,
        ...
        vesting_balance_create_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        vesting_balance_create_props.update({
            "creator": creator,
            "owner": owner,
            "extensions": extensions
        })
        vesting_balance_create_props["amount"].update({
            "amount": amount,
            "asset_id": amount_asset_id
        })
        ...
        if debug_mode:
            lcc.log_debug(
                "Vesting balance create operation: \n{}".format(
    ...
    def get_vesting_balance_withdraw_operation(
        self,
        echo,
        vesting_balance,
        owner,
        ...
        vesting_balance_withdraw_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        ...
        vesting_balance_withdraw_props["amount"].update({
            "amount": amount,
            "asset_id": amount_asset_id
        })
        if debug_mode:
            lcc.log_debug(
                "Vesting balance withdraw operation: \n{}".format(
    ...
    def get_balance_claim_operation(
        ...
        value_amount,
        balance_owner_private_key=None,
        fee_amount=0,
        fee_asset_id="1.3.0",
        ...
        balance_claim_operation_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        ...
        balance_claim_operation_props["total_claimed"].update({
            "amount": value_amount,
            "asset_id": value_asset_id
        })
        if debug_mode:
    ...
    def get_balance_freeze_operation(
        self,
        echo,
        account,
        value_amount,
        ...
        balance_freeze_operation_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        balance_freeze_operation_props["amount"].update({
            "amount": value_amount,
            "asset_id": value_asset_id
        })
        balance_freeze_operation_props.update({
            "account": account,
            "duration": duration,
            "extensions": extensions
        })
    ...
    def get_balance_unfreeze_operation(
        self, echo, account, amount=0, asset_id="1.3.0", extensions=None, signer=None, debug_mode=False
    ):
        if extensions is None:
            extensions = []
        ...
        balance_unfreeze_operation_props["amount"].update({
            "amount": amount,
            "asset_id": asset_id
        })
        balance_unfreeze_operation_props.update({
            "account": account,
            "extensions": extensions
        })
    ...
    def get_request_balance_unfreeze_operation(
        ...
        if extensions is None:
            extensions = []
        operation_id = echo.config.operation_ids.REQUEST_BALANCE_UNFREEZE
        request_balance_unfreeze_operation = self.get_operation_json("request_balance_unfreeze_operation")
        request_balance_unfreeze_operation["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        request_balance_unfreeze_operation.update({
            "account": account,
            'objects_to_unfreeze': objects_to_unfreeze,
            "extensions": extensions
        })
        if debug_mode:
            lcc.log_debug(
                "Request balance unfreeze operation: \n{}".format(
                    json.dumps([operation_id, request_balance_unfreeze_operation], indent=4)
                )
            )
        if signer is None:
            return [operation_id, request_balance_unfreeze_operation, account]
        return [operation_id, request_balance_unfreeze_operation, signer]
    ...
    def get_contract_create_operation(
        ...
        contract_create_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        ...
        contract_create_props["value"].update({
            "amount": value_amount,
            "asset_id": value_asset_id
        })
        if debug_mode:
    ...
    def get_contract_call_operation(
        ...
        contract_call_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        ...
        contract_call_props["value"].update({
            "amount": value_amount,
            "asset_id": value_asset_id
        })
        if debug_mode:
    ...
    def get_account_address_create_operation(
        self, echo, owner, label, fee_amount=1, fee_asset_id="1.3.0", extensions=None, signer=None, debug_mode=False
    ):
        if extensions is None:
            extensions = []
        ...
        account_address_create_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        account_address_create_props.update({
            "owner": owner,
            "label": label,
            "extensions": extensions
        })
    ...
    def get_transfer_to_address_operation(
        self,
        echo,
        from_account_id,
        to_address,
        ...
        transfer_to_address_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        transfer_to_address_props.update({
            "from": from_account_id,
            "to": to_address,
            "extensions": extensions
        })
        transfer_to_address_props["amount"].update({
            "amount": amount,
            "asset_id": amount_asset_id
        })
        if debug_mode:
    ...
    def get_sidechain_eth_create_address_operation(
        self, echo, account, fee_amount=0, fee_asset_id="1.3.0", extensions=None, signer=None, debug_mode=False
    ):
        if extensions is None:
            extensions = []
        ...
        generate_eth_address_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        generate_eth_address_props.update({
            "account": account,
            "extensions": extensions
        })
        if debug_mode:
    ...
    def get_evm_address_register_operation(
        ...
        evm_address_register_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        evm_address_register_props.update({
            "owner": account,
    ...
    def get_sidechain_eth_withdraw_operation(
        self,
        echo,
        account,
        eth_addr,
        ...
        withdraw_eth_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        withdraw_eth_props.update({
            "account": account,
            "eth_addr": eth_addr,
            "value": value,
            "extensions": extensions
    ...
    def get_contract_fund_pool_operation(
        self,
        echo,
        sender,
        contract,
        ...
        contract_fund_pool_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        contract_fund_pool_props.update({
            "sender": sender,
            "contract": contract,
            "extensions": extensions
        })
        contract_fund_pool_props["value"].update({
            "amount": value_amount,
            "asset_id": value_asset_id
        })
        if debug_mode:
    ...
    def get_contract_whitelist_operation(
        self,
        echo,
        sender,
        contract,
        ...
        contract_whitelist_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
    ...
    def get_sidechain_erc20_register_token_operation(
        self,
        echo,
        account,
        eth_addr,
        ...
        register_erc20_token_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
    ...
    def get_sidechain_erc20_withdraw_token_operation(
        self,
        echo,
        account,
        to,
        ...
        withdraw_erc20_token_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
    ...
    def get_contract_update_operation(
        self,
        echo,
        sender,
        contract,
        ...
        contract_update_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        contract_update_props.update({
            "sender": sender,
            "contract": contract,
            "extensions": extensions
        })
    ...
    def get_sidechain_btc_create_address_operation(
        self,
        echo,
        account,
        backup_address,
        ...
        generate_btc_address_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
    ...
    def get_sidechain_btc_withdraw_operation(
        self,
        echo,
        btc_address,
        value,
        ...
        create_btc_withdraw_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
    ...
    def did_create_operation(
        self, echo, registrar, essence, public_keys, fee_asset_id="1.3.0", fee_amount=0, signer=None, debug_mode=False
    ):
        operation_id = echo.config.operation_ids.DID_CREATE
        did_create_props = self.get_operation_json("did_create_operation")
        did_create_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        did_create_props.update({
            "registrar": registrar,
            "essence": essence,
    ...
    def did_update_operation(
        ...
        did_update_props.update({
            ...
            "pub_keys_to_delete": pub_keys_to_delete,
    ...
    def did_delete_operation(
        self, echo, registrar, did_identifier, fee_asset_id="1.3.0", fee_amount=0, signer=None, debug_mode=False
    ):
        operation_id = echo.config.operation_ids.DID_DELETE
        did_delete_props = self.get_operation_json("did_update_operation")
        did_delete_props["fee"].update({
            "amount": fee_amount,
            "asset_id": fee_asset_id
        })
        did_delete_props.update({
            "registrar": registrar,
            "did_identifier": did_identifier
        })
        if debug_mode:

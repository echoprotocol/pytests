...
@lcc.prop("main", "type")
@lcc.tags("api", "wallet_api", "wallet_sidechain_erc20", "wallet_get_erc20_account_withdrawals")
...
class GetErc20AccountDeposits(WalletBaseTest, BaseTest):
    ...
    @lcc.test("Simple work of method 'wallet_get_erc20_account_withdrawals'")
    def method_main_check(self, get_random_valid_account_name, get_random_string, get_random_valid_asset_name):
        ...
        account_withdrawals = self.send_wallet_request(
            "get_erc20_account_withdrawals", [new_account_id], log_response=False
        )['result']
        self.check_erc20_account_withdrawals(
            account_withdrawals, new_account_id, erc20_withdrawal_amounts, withdrawal_erc20_token_ids
        )

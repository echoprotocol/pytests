...
@lcc.prop("main", "type")
@lcc.tags("api", "wallet_api", "wallet_contracts", "wallet_get_relative_contract_history")
@lcc.suite("Check work of method 'get_relative_contract_history'", rank=1)
class GetRelativeContractHistory(WalletBaseTest, BaseTest):
    ...
    @lcc.test("Simple work of method 'wallet_get_relative_contract_history'")
    def method_main_check(self):
        lcc.set_step("Сheck get_relative_contract_history method")
        response = self.send_wallet_request("get_relative_contract_history", [self.valid_contract_id, 0, 10, 20], log_response=False)['result']

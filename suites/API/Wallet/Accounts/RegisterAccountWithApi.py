...
class RegisterAccountWithApi(WalletBaseTest, BaseTest):
    ...
    def method_main_check(self, get_random_valid_account_name, get_random_eth_address):
        ...
        response = self.send_wallet_request("register_account_with_api", [new_account, public_key, public_key, evm_address], log_response=False)

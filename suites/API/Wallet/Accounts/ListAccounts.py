    ...
    def method_main_check(self):
        ...
        for entry in range(limit):
            ...
            if not self.type_validator.is_account_id(list_account_entry_id):
                ...
                lcc.log_info("List account entry id '{}' has correct format: account_object_type".format(list_account_entry_id))
            ...
            if not self.type_validator.is_account_name(list_account_entry_name):
                ...
                lcc.log_info("List account entry name '{}' has correct format: account_object_type".format(list_account_entry_name))

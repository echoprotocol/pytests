...
@lcc.prop("main", "type")
@lcc.tags("api", "database_api", "database_api_authority_validation", "validate_transaction")
...
class ValidateTransaction(BaseTest):
    ...
    def method_main_check(self):
        ...
        signed_transaction = self.echo_ops.broadcast(
        ...
        response_id = self.send_request(
            self.get_request("validate_transaction", [signed_transaction]), self.__database_api_identifier
        )
        ...
        require_that("'transaction from 'validate_transaction' result'", validate_transaction, has_length(9))

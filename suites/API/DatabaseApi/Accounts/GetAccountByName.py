...
class GetAccountByName(BaseTest):
    ...
    def method_main_check(self):
        ...
        response_id = self.send_request(
            self.get_request("get_account_by_name", [self.committee_account]), self.__database_api_identifier
        )
...
class PositiveTesting(BaseTest):
    ...
    @lcc.depends_on("API.DatabaseApi.Accounts.GetAccountByName.GetAccountByName.method_main_check")

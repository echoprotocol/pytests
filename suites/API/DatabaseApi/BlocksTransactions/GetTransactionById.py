...
@lcc.tags("api", "database_api", "database_api_blocks_transactions", "get_transaction_by_id")
@lcc.suite("Check work of method 'get_transaction_by_id'", rank=1)
class GetTransactionById(BaseTest):
    ...
    @lcc.test("Simple work of method 'get_transaction_by_id'")
    def method_main_check(self):
        lcc.set_step("Collect 'get_transfer' operation")

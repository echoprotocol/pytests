...
class PositiveTesting(BaseTest):
    ...
    @lcc.depends_on("API.DatabaseApi.CommitteeMembers.GetCommitteeMemberByAccount.GetCommitteeMemberByAccount.method_main_check")
    ...
    @lcc.depends_on("API.DatabaseApi.CommitteeMembers.GetCommitteeMemberByAccount.PositiveTesting.create_committee_member")

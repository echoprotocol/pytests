...
class GetCommitteeMemberByAccount(BaseTest):
    ...
    def method_main_check(self):
        ...
        for i, account_id in enumerate(account_ids):
            ...
            response_id = self.send_request(
                self.get_request("get_committee_member_by_account", [account_id]),
...
class PositiveTesting(BaseTest):
    ...
    @lcc.depends_on(
        "API.DatabaseApi.CommitteeMembers.GetCommitteeMemberByAccount.GetCommitteeMemberByAccount.method_main_check"
    )
    def create_committee_member(
        ...
        response_id = self.send_request(
            self.get_request("get_committee_member_by_account", [self.new_account_id]), self.__database_api_identifier
        )
    ...
    @lcc.depends_on(
        "API.DatabaseApi.CommitteeMembers.GetCommitteeMemberByAccount.PositiveTesting.create_committee_member"
    )

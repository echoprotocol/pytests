...
class ContractWhitelist(BaseTest):
    ...
    def method_main_check(self, get_random_integer_up_to_ten):
        ...
        contract_whitelist_operation = self.echo_ops.get_contract_whitelist_operation(echo=self.echo,
                                                                                      sender=self.echo_acc0,
                                                                                      contract=contract_id,
                                                                                      add_to_whitelist=[self.echo_acc1],
                                                                                      add_to_blacklist=[self.echo_acc0])
        collected_contract_whitelist = self.collect_operations(contract_whitelist_operation,
                                                               self.__database_api_identifier)

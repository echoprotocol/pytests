...
SUITE = {
    "description": "Operation 'vesting_balance_create'"
}


@lcc.prop("main", "type")
@lcc.prop("positive", "type")
@lcc.tags("operations", "vesting_balances_operations", "vesting_balance_create")
@lcc.suite("Check work of method 'vesting_balance_create'", rank=1)
class VestingBalanceCreate(BaseTest):
    ...
    @lcc.test("Simple work of method 'vesting_balance_create'")
    def method_main_check(self, get_random_valid_asset_name, get_random_integer, get_random_valid_account_name):
        ...
        lcc.log_info("'vesting_balance_create' operation broadcasted successfully")

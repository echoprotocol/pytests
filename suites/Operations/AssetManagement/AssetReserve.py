...
class AssetReserve(BaseTest):
    ...
    def method_main_check(
        ...
        asset_reserve_operation = self.echo_ops.get_asset_reserve_operation(
            echo=self.echo, payer=new_account, reserve_amount=value_amount, reserve_asset_id=new_asset_id
        )

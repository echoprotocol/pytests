...
class AssetPublishFeed(BaseTest):
    ...
    def method_main_check(self, get_random_valid_asset_name, get_random_valid_account_name, get_random_integer):
        ...
        asset_update_feed_producers_operation = self.echo_ops.get_asset_update_feed_producers_operation(
            echo=self.echo, issuer=new_account, asset_to_update=new_asset_id, new_feed_producers=[new_account]
        )
        self.utils.add_balance_for_operations(
            self, new_account, asset_update_feed_producers_operation, self.__database_api_identifier
        )
        lcc.log_info("Balance to account added")
        ...
        self.utils.add_balance_for_operations(
            self, new_account, asset_publish_feed_operation, self.__database_api_identifier
        )
        lcc.log_info("Balance to account added")

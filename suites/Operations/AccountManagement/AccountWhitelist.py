...
class AccountWhitelist(BaseTest):
    ...
    def method_main_check(self, get_random_valid_account_name):
        ...
        operation = self.echo_ops.get_account_whitelist_operation(
            self.echo, authorizing_account=self.echo_acc0, account_to_list=new_account, new_listing=1
        )
        ...
        operation = self.echo_ops.get_account_whitelist_operation(
            self.echo, authorizing_account=self.echo_acc0, account_to_list=new_account, new_listing=2
        )
        ...
        operation = self.echo_ops.get_account_whitelist_operation(
            self.echo, authorizing_account=self.echo_acc0, account_to_list=new_account, new_listing=3
        )
        ...
        operation = self.echo_ops.get_account_whitelist_operation(
            self.echo, authorizing_account=self.echo_acc0, account_to_list=new_account, new_listing=0
        )

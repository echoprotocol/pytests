...
@lcc.suite("Check work of operation 'committee_member_create'", rank=1)
class CommitteeMemberCreate(BaseTest):
    ...
    @lcc.test("Simple work of operation 'committee_member_create'")
    def method_main_check(self, get_random_valid_account_name, get_random_eth_address, get_random_btc_public_key):
        ...
        check_that("'committee_member_by_account' method result", committee_member, equal_to(None), quiet=True)

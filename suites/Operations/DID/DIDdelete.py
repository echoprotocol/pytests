...
from lemoncheesecake.matching import is_none, require_that
...
class DIDDelete(BaseTest):
    ...
    def method_main_check(self):
        ...
        transfer_operation = self.echo_ops.did_delete_operation(
            echo=self.echo, registrar=self.echo_acc0, did_identifier="255." + did_id
        )
        collected_operation = self.collect_operations(transfer_operation, self.__database_api_identifier)

...
@lcc.suite("Check scenario 'Hello World'", rank=2)
class HelloWorld(BaseTest):
    ...
    def perform_operations(self, list_operations):
        if type(list_operations) is list:
            list_operations = [list_operations]
        for i in range(len(list_operations)):
            self.add_fee_to_operation(list_operations[i], self.__database_api_identifier)
        ...
        return self.get_trx_completed_response(response_id)
    ...
    def hello_world_scenario(self):
        ...
        contract_id_16 = self.perform_operations(list_operations=operation)
        ...
        response = self.perform_operations(list_operations=operation)
        ...
        self.perform_operations(list_operations=operation)

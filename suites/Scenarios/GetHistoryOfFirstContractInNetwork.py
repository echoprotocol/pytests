...
class GetHistoryOfFirstContractInNetwork(BaseTest):
    ...
    def get_history_of_first_contract_scenario(self):
        ...
        response_id = self.send_request(
            self.get_request("get_objects", [[self.contract_id]]), self.__database_api_identifier
        )
        ...
        check_that("''{}' contract history'".format(self.contract_id), response["result"], is_not_none(), quiet=True)

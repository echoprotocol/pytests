...
@lcc.tags("api", "database_api", "database_api_contracts", "get_contract_result")
...
class PositiveTesting(BaseTest):
    ...
    @lcc.depends_on("DatabaseApi.Contracts.GetContractResult.GetContractResult.method_main_check")

...
@lcc.tags("api", "database_api", "database_api_balances", "get_named_account_balances")
...
class PositiveTesting(BaseTest):
    ...
    @lcc.depends_on("DatabaseApi.Balances.GetNamedAccountBalances.GetNamedAccountBalances.method_main_check")

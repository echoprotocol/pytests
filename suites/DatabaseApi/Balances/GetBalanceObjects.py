...
@lcc.tags("api", "database_api", "database_api_balances", "get_balance_objects")
...
class PositiveTesting(BaseTest):
    ...
    @lcc.depends_on("DatabaseApi.Balances.GetBalanceObjects.PositiveTesting.get_balance_objects_for_several_address")

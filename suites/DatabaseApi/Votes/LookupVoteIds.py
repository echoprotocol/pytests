...
class PositiveTesting(BaseTest):
    ...
    @lcc.depends_on("DatabaseApi.Votes.LookupVoteIds.LookupVoteIds.method_main_check")
    ...
    @lcc.depends_on("DatabaseApi.Votes.LookupVoteIds.PositiveTesting.create_committee_member")

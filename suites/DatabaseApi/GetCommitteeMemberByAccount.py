...
class PositiveTesting(BaseTest):
    ...
    @lcc.depends_on("DatabaseApi.GetCommitteeMemberByAccount.GetCommitteeMemberByAccount.method_main_check")
    ...
    @lcc.depends_on("DatabaseApi.GetCommitteeMemberByAccount.PositiveTesting.create_committee_member")
